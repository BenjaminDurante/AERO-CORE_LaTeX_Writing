...
The following MATLAB code automatically saves generated MATLAB figures which are currently open. 
...
\Cref{tab:tenseBasedOnSection} is generated using the following \LaTeX\ source code:
